                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-12">
                                    <ul class="breadcome-menu">
                                        ...
                                        <li><span class="bread-blod">Add FunctionServices</span>
                                        </li>
                                    </ul>
                                </div>
                            </div>
                                    ...
                                    <div class="row">
                                        <div class="col-lg-12 col-md-6 col-sm-6 col-xs-12">
                                            <div class="basic-login-inner">
                                                <h3>Add FunctionServices</h3>
                                                <form action="admin/services/add_functionServices" method="POST" enctype="multipart/form-data">
                                                    @csrf
