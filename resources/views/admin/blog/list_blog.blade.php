                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-6">
                                    <ul class="breadcome-menu">
                                        ...
                                        <li><span class="bread-blod">list_blog</span>
                                        </li>
                                    </ul>
                                </div>
                            </div>
                                            ...
                                            @foreach($listBlog as $key => $blog)
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <a href="{{route('admin.blog.deBlog',['id'=>$blog->id])}}" class="btn btn-danger rounded-circle ml-3"><i class="fas fa-trash-alt text-white">delete</i>
                                                        </a>
