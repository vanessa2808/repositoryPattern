                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-12">
                                    <ul class="breadcome-menu">
                                        ...
                                        <li><span class="bread-blod">Add Images</span>
                                        </li>
                                    </ul>
                                </div>
                            </div>
                                    ...
                                    <div class="row">
                                        <div class="col-lg-12 col-md-6 col-sm-6 col-xs-12">
                                            <div class="basic-login-inner">
                                                ...
                                                <form action="admin/activities/add_image" method="POST" enctype="multipart/form-data">
                                                    @csrf
                                                    ...
                                                    <div class="form-group-inner">
                                                        <label>Image4</label>
                                                        <input type="file" class="form-control" placeholder="Enter image" name="image4" />
                                                    </div>

                                                    <div class="form-group-inner">
                                                        <label>Image5</label>
                                                        <input type="file" class="form-control" placeholder="Enter image" name="image5" />
                                                    </div>
