                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-6">
                                    <ul class="breadcome-menu">
                                        ...
                                        <li><span class="bread-blod">Add Header Contact</span>
                                        </li>
                                    </ul>
                                </div>
                            </div>
                                    ...
                                    <div class="row">
                                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                            <div class="basic-login-inner">
                                                <h3>Add header Service</h3>
                                                <form action="admin/header/add_headerService" method="POST" enctype="multipart/form-data">
                                                    @csrf
