                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-12">
                                    <ul class="breadcome-menu">
                                        ...
                                        <li><span class="bread-blod">Add Chef</span>
                                        </li>
                                    </ul>
                                </div>
                            </div>
                                    ...
                                    <div class="row">
                                        <div class="col-lg-12 col-md-6 col-sm-6 col-xs-12">
                                            <div class="basic-login-inner">
                                                <h3>Add Chef</h3>
                                                <form action="admin/chef/add_chef" method="POST" enctype="multipart/form-data">
                                                    @csrf
                                                    ...
                                                    <div class="login-btn-inner">
                                                        <div class="inline-remember-me">
                                                            <button class="btn btn-sm btn-primary pull-right login-submit-cs" type="submit">Insert into</button>
                                                            <label>
